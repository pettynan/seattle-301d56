...
function displayPics(){
  ...
  // It's because the 'rando' variable was defined using let, inside of a while loop that was closed before this console log is run. The scope of rando is limited to that while loop.
  console.log(viewed);
